...
module.exports = async function generateDirectLineToken(botId, botTenantId) {
  ...
  const response = await fetch('https://a5693f94fce2e951b6b8257b9c1e97.4a.environment.api.powerplatform.com/powervirtualagents/botsbyschema/new_helper/directline/token?api-version=2022-03-01-preview&botId=' + botId + '&tenantId=' + botTenantId, {method: "GET"});
